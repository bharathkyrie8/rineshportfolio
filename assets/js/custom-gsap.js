    ...
    $(".smooth a").on("click", function (event) {
      ...
      if (href && href.startsWith("#") && href.length > 1) {
        ...
        if (target.length) {
          ...
          var smoother = window.smoother || (typeof ScrollSmoother !== 'undefined' ? ScrollSmoother.get() : null);
          if (smoother) {
            var offset = (href === "#works" ? "top 10px" : "top 100px");
            smoother.scrollTo(href, true, offset);
          } else {
            $("html, body")
              .stop()
              .animate(
...
desktop_three: "((min-width: 1400px) and (max-width: 1599px))",
  ...
  ////////////////////////////////////////////////////
  // 06. Footer Title
  if ($(".animated-title").length > 0 && typeof chroma !== "undefined") {
...
hoverItem.forEach((item, i) => {
  ...
  if ($(".testimonial-two-main").length) {
