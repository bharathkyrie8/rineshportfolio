...
(function ($) {
  ...
  if ($(".tw-main-menu-content").length && $(".tw-main-menu-mobile").length) {
    let navEl = document.querySelector(".tw-main-menu-content");
    let mobileNavContainer = document.querySelector(".tw-main-menu-mobile");
    if (navEl && mobileNavContainer) {
      mobileNavContainer.innerHTML = navEl.outerHTML;
    }
  ...
  $(".tw-offcanvas-open-btn").on("click", function () {
    ...
    $(".side-overlay, .overlay, .body-overlay").addClass("opened apply");
  ...
  ////////////////////////////////////////////////////
  // 05. offcanvas two Menu JS
  $(".tw-offcanvas-2-close-btn, .side-overlay, .overlay, .body-overlay").on("click", function () {
    setTimeout(() => {
      $(".tw-text-hover-effect-word").removeClass("animated-text");
    }, 1200);

    $(".tw-offcanvas-2-area").removeClass("opened");
    $(".side-overlay, .overlay, .body-overlay").removeClass("opened apply");
  });

  // Auto-close mobile offcanvas drawer when a navigation link is clicked
  $(document).on("click", ".tw-main-menu-mobile a", function (e) {
  ...
  function activeService(active_bg, e) {
    ...
    var featureWidget = $(".feature-widget");
    if (!featureWidget.length || !featureWidget.offset() || !e.offset()) return false;
    var topOff = e.offset().top;
    var height = e.outerHeight();
    var menuTop = featureWidget.offset().top;
